...
public class XMLStatementBuilder extends BaseBuilder {
    ...
    public void parse() {
        ...
        String resultMapId = context.getStringAttribute("resultMap");
        ResultMap resultMap = configuration.getResultMap(builderAssistant.applyCurrentNamespace(resultMapId));
        builderAssistant.addMapperStatement(keyStatementId, sqlCommandType, sqlSource,resultMap);
    }
